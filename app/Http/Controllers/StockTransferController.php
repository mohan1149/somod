...
class StockTransferController extends Controller
{
    ...
    public function index()
    {
        ...
        $statuses = $this->stockTransferStatuses_full();
    ...
    {   
		$myStatuses = [];
		$myStatuses['pending'] = __('lang_v1.pending');
		if(auth()->user()->OEX_STOCK_TRANSFER_APPROVAL)
		{
			$myStatuses['in_transit'] = __('lang_v1.in_transit');
			$myStatuses['completed'] = __('restaurant.completed');
		}
	...
	private function stockTransferStatuses_full()
    {   
