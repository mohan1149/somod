...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $sells = Transaction::leftJoin('contacts', 'transactions.contact_id', '=', 'contacts.id')
                ...
                // ->where('transactions.trasaction_type','!=','outside')
                ->select(
                    'transactions.id',
            ...
            $datatable = Datatables::of($sells)
                ...
                ->editColumn('res_order_status',function ($row) {
                    if($row->res_order_status == 'pending'){
    ...
    public function updateSale($id){
        try {
            DB::table("transactions")->where('id',$id)->update(['res_order_status'=>'completed']);
    ...
    public function edit($id)
    {
        ...
        return view('sell.edit')
            ->with(compact('business_details', 'taxes', 'sell_details', 'transaction', 'commission_agent', 'types', 'customer_groups', 'pos_settings', 'waiters', 'invoice_schemes', 'default_invoice_schemes', 'redeem_details', 'edit_discount', 'edit_price', 'accounts', 'shipping_statuses','customer_areas'));
    }
