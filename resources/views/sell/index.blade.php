...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        "ajax": {
            ...
            "data": function ( d ) {
				...
				d.payment_methods=$('#sell_list_filter_payment_method').val();				
    ...
    $(document).on('change', '#sell_list_filter_location_id, #sell_list_filter_customer_id,#sell_list_filter_payment_status,#created_by, #sales_cmsn_agnt, #service_staffs,#sell_list_filter_payment_method',  function() {
		debugger
        sell_table.ajax.reload();
    });
    @if($is_woocommerce)
