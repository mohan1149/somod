...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('sell_list_filter_payment_method',  __('purchase.payment_method') . ':') !!}
        {!! Form::select('sell_list_filter_payment_method', ['Cash' => __('lang_v1.Cash'), 'Card' => __('lang_v1.Card')], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
    </div>
</div>
