			...
			<div class="col-md-12">
                    <div class="checkbox">
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_SHOW_HRM', 'OEX_SHOW_HRM', false, 
                      ...
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_SHOW_POSTAB', 'OEX_SHOW_POSTAB', false, 
                      ...
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_STORE_MANAGER', 'OEX_STORE_MANAGER', false, 
                      ...
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_STOCK_TRANSFER_APPROVAL', 'OEX_STOCK_TRANSFER_APPROVAL', false, 
