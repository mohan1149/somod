    ...
    <div class="row">
        ...
        @component('components.widget', ['title' => __('lang_v1.roles_and_permissions')])
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox">
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_SHOW_HRM', 'OEX_SHOW_HRM', $user->OEX_SHOW_HRM, 
                      ...
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_SHOW_POSTAB', 'OEX_SHOW_POSTAB', $user->OEX_SHOW_POSTAB, 
                    ...
                    <div class="checkbox">
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_STOCK_TRANSFER_APPROVAL', 'OEX_STOCK_TRANSFER_APPROVAL', $user->OEX_STOCK_TRANSFER_APPROVAL, 
                      ...
                      <label>	
                        ...
                        {!! Form::checkbox('OEX_STORE_MANAGER', 'OEX_STORE_MANAGER', $user->OEX_STORE_MANAGER, 
            ...
            <div class="col-md-9">
				...
				@foreach($permitted_locations as $permitted_location)
				{{$permitted_location}}
				 @endforeach
@endif
