...
<div class="col-xs-12">
    @component('components.widget')
        ...
        <small class="help-block">(@lang('report.closing_stock') + @lang('home.total_sell') + @lang('report.total_stock_recovered') + @lang('lang_v1.total_purchase_return') + @lang('lang_v1.total_purchase_discount')) <br> - (@lang('report.opening_stock') + @lang('home.total_purchase') + @lang('report.total_expense') @if($essentials_enabled) + @lang('essentials::lang.total_payroll') @endif + @lang('lang_v1.total_shipping_charges') + @lang('lang_v1.total_sell_discount') + @lang('lang_v1.total_reward_amount'))</small>
    @endcomponent
</div>
</span>