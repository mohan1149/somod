...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-6">
            @component('components.widget', ['title' => __('sale.outside_orders')])
            <table class="table table-striped">
                <tr>
                    <th>{{ __('report.total_outdoor_orders') }}:</th>
                    <td>
                ...
                <tr>
                    <th>{{ __('report.total_completed') }}:</th>
                    <td>
                ...
                <tr>
                    <th>{{ __('report.total_outdoor_orders_value') }}:</th>
                    <td>
        ...
        <div class="col-xs-6">
            @component('components.widget', ['title' => __('sale.subscriptions')])
            <table class="table table-striped">
                <tr>
                    <th>{{ __('report.total_subscriptions') }}:</th>
                    <td>
        ...
        {{-- expenses report --}}
        <div class="col-xs-6">
            @component('components.widget', ['title' => __('sale.expenses')])
            <table class="table table-striped">
                <tr>
                    <th>{{ __('report.total_expenses') }}:</th>
                    <td>
                ...
                <tr>
                    <th>{{ __('report.total_paid_expenses') }}:</th>
                    <td>
                ...
                <tr>
                    <th>{{ __('report.total_unpaid_expenses') }}:</th>
                    <td>
