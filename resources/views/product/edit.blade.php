...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('subscription_definition', __('product.subscription_definition') . ':*') !!}
              {!! Form::select('subscription_definition', ['none'=>'None','meal'=>'Meal','snack'=>'Snack'], $product->subscription_definition, ['class' => 'form-control select2', 'required']); !!}
          </div>
        </div>
