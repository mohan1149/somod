    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        auth()->user()->can('category.create') )
          <li class="treeview {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group', 'brands', 'units', 'categories', 'warranties']) ? 'active active-sub' : '' }}" id="tour_step5">
            ...
            <ul class="treeview-menu">
              ...
              @endcan
                ...
                <li class="{{ $request->segment(2) == 'product-stock-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getProductStockReport')}}"><i class="fa fa-hourglass-half" aria-hidden="true"></i>@lang('report.stock_report')</a></li>
              @endcan
              ...
              @endcan
              @can('product.create')
                <li class="{{ $request->segment(1) == 'gift-vouchers' }}"><a href="{{action('GiftVoucherController@index')}}"><i class="fa fa-gift"></i>@lang('lang_v1.gift_vouchers')</a></li>
              @endcan
              @can('product.create')
                <li class="{{ $request->segment(1) == 'gift-redeems' }}"><a href="/gift-redeems"><i class="fa fa-plus-circle"></i>@lang('lang_v1.gift_redeems')</a></li>
              @endcan
              @can('product.view')
          ...
          <li class="treeview {{  in_array( $request->segment(1), ['reports']) ? 'active active-sub' : '' }}" id="tour_step8">
            ...
            <ul class="treeview-menu">
              ...
              @can('purchase_n_sell_report.view')
                ...
                <li class="{{ $request->segment(2) == 'today' ? 'active' : '' }}" ><a href="/reports/today/profits"><i class="fa fa-exchange"></i>@lang('lang_v1.today_profits')</a></li>
              @endcan
              ...
              @can('expense_report.view')
                ...
                <li class="{{ $request->segment(2) == 'expense-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getExpenseReportV2')}}"><i class="fa fa-search-minus" aria-hidden="true"></i></i>@lang('report.expense_report')</a></li>
        ...
        {{-- outside order menu --- START --}}
        <li class="treeview @if( $request->segment(1) == 'outside-orders' || $request->segment(1) == 'drivers' || $request->segment(1) == 'outside-customers') {{'active active-sub'}} @endif">
        	<a href="#" ><i class="fa fa-cog"></i> <span>@lang('lang_v1.outside_orders')</span>
            	<span class="pull-right-container">
              		<i class="fa fa-angle-left pull-right"></i>
            	</span>
          	</a>
          	<ul class="treeview-menu" >
            	<li class="treeview {{ $request->segment(1) == 'outside-orders' && $request->segment(2) == '' ? 'active active-sub' : '' }}">
            		<a href="{{action('OutsideOrderController@index')}}"><i class="fa fa-cogs"></i> <span>@lang('lang_v1.outside_orders')</span></a>
            	</li>
            	<li class="treeview {{ ($request->segment(1) == 'outside-customers') ? 'active active-sub' : '' }}">
            		<a href="{{action('OutsideCustomerController@index')}}"><i class="fa fa-users"></i> <span>@lang('lang_v1.customers')</span></a>
            	</li>
            	<li class="treeview {{ ($request->segment(1) == 'drivers') ? 'active active-sub' : '' }}">
            		<a href="{{action('DriverController@index')}}"><i class="fa fa-car"></i> <span>@lang('lang_v1.drivers')</span></a>
            	</li>
          	</ul>
        <li>
        {{-- outside order menu --- END --}}
        ...
        <li class="treeview @if( in_array($request->segment(1), ['business', 'tax-rates', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'subscription', 'types-of-service']) || in_array($request->segment(2), ['tables', 'modifiers']) ) {{'active active-sub'}} @endif">
          ...
          <ul class="treeview-menu" id="tour_step3">
            ...
            @if(in_array('types_of_service', $enabled_modules))
              <li class="{{  $request->segment(1) == 'types-of-service' ? 'active active-sub' : '' }}">
                  <a href="{{action('TypesOfServiceController@index')}}"><i class="fa fa-user-circle-o"></i> <span>@lang('lang_v1.types_of_service')</span>
                  </a>
              </li>
              @endif
        ...
        @if(Module::has('Essentials'))
	       {{-- @if(auth()->user()->OEX_SHOW_HRM == true)
