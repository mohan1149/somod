...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <button type="button" id="view_suspended_sales" title="{{ __('lang_v1.vallet') }}" data-toggle="tooltip" data-placement="bottom" class="btn bg-yellow btn-flat m-6 btn-xs m-5 btn-modal pull-right" data-container=".vallet_form" 
          data-href="/vallets">
