<div class="row payment_panel">
	<div class="container-fluid">
		...
		{{-- <a 
			...
			href="{{action('OutsideOrderController@index')}}" 
		>
			@lang('lang_v1.all_outside_orders')
		</a> --}}
	</div>
	<div class="col-sm-12">
					...
					<tr>
						<td>
							{{-- <div class="col-sm-2 col-xs-6 col-2px-padding">
								<button 
									type="button" 
									class="btn btn-block btn-primary btn-modal outside-order" 
                    				data-href="{{action('OutsideOrderController@create')}}" 
                    				data-container=".outside_order_modal"
									id="pos-outside"
								>
                    				@lang('sale.outside_orders')
								</button>
								<button type="button" 
							...
							<div class="col-sm-3 col-xs-6 col-2px-padding">
								...
								@endif --}}
								{{-- <button type="button" 
									class="btn bg-blue btn-block btn-flat no-print btn-modal" 
									data-href="/vallet-form" 
                    				data-container=".vallet_form"
									title="@lang('lang_v1.vallet')" >
									<div class="text-center">
	    								<b>@lang('lang_v1.vallet')</b>
	    							</div>
								</button> --}}
							</div>
							<div class="col-sm-4 col-xs-12 col-2px-padding">
								{{-- <button type="button" 
									class="btn btn-info btn-block btn-flat add_new_booking_btn" 
								>	@lang('restaurant.add_booking')
								</button>
								<button type="button" 
									class="pos-express-finalize btn btn-info bg-navy btn-block btn-flat online_pay" 
