	...
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				{!! Form::text("", null, ['class' => 'form-control','required', 'placeholder' => __('lang_v1.card_transaction_no'), 'id' => "card_transaction_number"]); !!}
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				{!! Form::select('card_type', ['knet' => 'KNET','visa' => 'Visa', 'master' => 'MasterCard'], 'knet', ['class'=>'form-control select2','id'=>'card_type']) !!}
				{{-- {!! Form::select("", ['type'=>'Type','knet' => 'KNET','visa' => 'Visa', 'master' => 'MasterCard','cheque' => 'Cheque'], 'type',['class' => 'form-control select2', 'id' => "card_type" ]); !!} --}}
			</div>
		</div>
		<div class="col-md-12">
			<div class="form-group">
				{!! Form::label("card_transaction_notes",__('lang_v1.card_transaction_notes')) !!}
				{!! Form::textarea("", null, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_transaction_notes'), 'id' => "card_transaction_notes"]); !!}
			</div>
		</div>
		{{-- <div class="col-md-3">
			<div class="form-group">
