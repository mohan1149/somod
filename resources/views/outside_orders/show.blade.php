<div class="modal-dialog modal-xl no-print" role="document">
  ...
  <div class="modal-body">
        ...
        {{-- <div class="col-sm-4">
          ...
          @if(in_array('types_of_service' ,$enabled_modules))
            ...
            @if(!empty($sell->types_of_service->enable_custom_fields))
              <strong>@lang('lang_v1.service_custom_field_1'):</strong>
              {{$sell->service_custom_field_1}}<br>
              <strong>@lang('lang_v1.service_custom_field_2'):</strong>
              {{$sell->service_custom_field_2}}<br>
              <strong>@lang('lang_v1.service_custom_field_3'):</strong>
              {{$sell->service_custom_field_3}}<br>
              <strong>@lang('lang_v1.service_custom_field_4'):</strong>
    ...
    <div class="modal-footer">
      <a href="#" class="print-outside-order-invoice btn btn-primary" data-href="{{route('outsideorder.printInvoice', [$sell->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print")</a>
