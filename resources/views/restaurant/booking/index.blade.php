        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    {{-- <div class="row">
                        <div class="col-lg-4">
                            {!! Form::label('service',__('lang_v1.service')) !!}
                            {!! Form::select('service', [],null, ['class'=>'form-control service_filter']) !!}
                        </div>
                        <div class="col-lg-4">
                            {!! Form::label('service',__('restaurant.service_staff')) !!}
                            {!! Form::select('service', [],null, ['class'=>'form-control service_filter']) !!}
                        </div>
                    </div> --}}
