...
<div class="form-group col-md-3">
    {!! Form::label('user_DateResidentStart', __( 'lang_v1.DateResidentStart' ) . ':') !!}
	<input type="date" name="OEX_DateStartResident" class="form-control" value="{{!empty($user->OEX_DateStartResident) ? $user->OEX_DateStartResident->format('yy-m-d') : null}}">

</div>

<div class="form-group col-md-3">
    {!! Form::label('user_DateResidentEnd', __( 'lang_v1.DateResidentEnd' ) . ':') !!}
		<input type="date" name="OEX_DateEndResident" class="form-control" value="{{!empty($user->OEX_DateEndResident) ? $user->OEX_DateEndResident->format('yy-m-d') : null}}">


</div>

<div class="form-group col-md-3">
    {!! Form::label('user_DateAssignment', __( 'lang_v1.DateAssignment' ) . ':') !!}
		<input type="date" name="OEX_DateAssignment" class="form-control" value="{{!empty($user->OEX_DateAssignment) ? $user->OEX_DateAssignment->format('yy-m-d') : null}}">
...
<div class="clearfix"></div>
<div class="form-group col-md-3">
    {!! Form::label('custom_field_1', __( 'lang_v1.user_custom_field1') . ':') !!}
    {!! Form::text('custom_field_1', !empty($user->custom_field_1) ? $user->custom_field_1 : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.user_custom_field1') ]); !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('custom_field_2', __( 'lang_v1.user_custom_field2') . ':') !!}
    {!! Form::text('custom_field_2', !empty($user->custom_field_2) ? $user->custom_field_2 : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.user_custom_field2') ]); !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('custom_field_3', __( 'lang_v1.user_custom_field3') . ':') !!}
    {!! Form::text('custom_field_3', !empty($user->custom_field_3) ? $user->custom_field_3 : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.user_custom_field3') ]); !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('custom_field_4', __( 'lang_v1.user_custom_field4') . ':') !!}
    {!! Form::text('custom_field_4', !empty($user->custom_field_4) ? $user->custom_field_4 : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.user_custom_field4') ]); !!}
</div>
<div class="form-group col-md-3">
