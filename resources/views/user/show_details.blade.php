<div class="row">
	...
	<div class="col-md-4">
		...
		<p><strong>@lang( 'lang_v1.DateAssignment' ):</strong> @if(!empty($user->OEX_DateAssignment)) {{@format_date($user->OEX_DateAssignment)}} @endif</p>
		<p><strong>@lang( 'lang_v1.DateResidentStart' ):</strong> @if(!empty($user->OEX_DateStartResident)) {{@format_date($user->OEX_DateStartResident)}} @endif</p>
		<p><strong>@lang( 'lang_v1.DateResidentEnd' ):</strong> @if(!empty($user->OEX_DateEndResident)) {{@format_date($user->OEX_DateEndResident)}} @endif</p>
	...
	<div class="col-md-4">
		<p><strong>@lang( 'lang_v1.user_custom_field1'):</strong> {{$user->custom_field_1 ?? ''}}</p>
		<p><strong>@lang( 'lang_v1.user_custom_field2'):</strong> {{$user->custom_field_2 ?? ''}}</p>
		<p><strong>@lang( 'lang_v1.user_custom_field3'):</strong> {{$user->custom_field_3 ?? ''}}</p>
		<p><strong>@lang( 'lang_v1.user_custom_field4'):</strong> {{$user->custom_field_4 ?? ''}}</p>
	</div>
