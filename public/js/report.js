$(document).ready(function() {
 ...
 { data: 'sku', name: 'variations.sub_sku' },
            { data: 'product', name: 'p.name' },
				 { data: 'location_name', name: 'l.name' },
            { data: 'unit_price', name: 'variations.sell_price_inc_tax',visible:false },
            { data: 'stock', name: 'stock', searchable: false },
            { data: 'stock_price', name: 'stock_price', searchable: false,visible:false },
            { data: 'total_sold', name: 'total_sold', searchable: false ,visible:false},
            { data: 'total_transfered', name: 'total_transfered', searchable: false,visible:false },
            { data: 'total_adjusted', name: 'total_adjusted', searchable: false,visible:false }
    ...
    product_stock_report_table = $('#product_stock_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            $('#footer_total_stock').html(__sum_stock($('#product_stock_report_table'), 'current_stock'));
           
            __currency_convert_recursively($('#product_stock_report_table'));
          },
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.total_outdoor_orders_value').html(
                __currency_trans_from_en(data.total_outside_orders_value, true)
            );
            $('.total_expenses').html(
                __currency_trans_from_en(data.total_expenses, true)
            );
            $('.total_paid_expenses').html(
                __currency_trans_from_en(data.total_paid_expenses, true)
            );
            $('.total_unpaid_expenses').html(
                __currency_trans_from_en(data.total_unpaid_expenses, true)
            );
...
$.ajax({
        method: 'GET',
        url: '/reports/profit-loss-payments',
        dataType: 'html',
        data: data,
        success: function(data) {
            $('#profit_loss_payments').html(data);
			__currency_convert_recursively($('#profit_loss_payments'));
