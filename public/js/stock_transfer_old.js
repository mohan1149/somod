...
function changeTransferStatus(btn,item_id)
{
  var item_value = $(btn).get(0).checked?1:0;
  
  var returnVal = confirm("Are you sure?");
         if(!returnVal)
         {
            $(btn).get(0).checked = !$(btn).get(0).checked;
             return;
         }
  


  $.post( "/stock-transfers/updateStatus?id=" + item_id + "&status=" + item_value).fail(function(){
