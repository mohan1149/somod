...
Route::middleware(['IsInstalled', 'bootstrap'])->group(function () {
    ...
    Route::post('ordersapi', 'SellPosController@placeOrdersOEXApi');
    Route::post('subscriptionapi', 'SubscriptionController@submitSubscriptionOEXApi');
...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone', 'bootstrap'])->group(function () {
    ...
    Route::get('/redeem-form/{id}/{left}', 'GiftVoucherController@redeemForm');
    Route::post('/redeem-voucher', 'GiftVoucherController@redeemVoucher');
    Route::delete('/delete-redeem/{id}', 'GiftVoucherController@deleteRedeem');
    Route::get('/vallet-form','GiftVoucherController@valletForm');
    Route::post('/add-vallet','GiftVoucherController@addVallet');
    Route::get('vallets','GiftVoucherController@getVallet');
    Route::delete('/delete/wallet/{wid}','GiftVoucherController@deleteWallet');


    Route::resource('/outside-orders', 'OutsideOrderController');
    Route::resource('/drivers', 'DriverController');
    Route::resource('/outside-customers', 'OutsideCustomerController');
    Route::get('/update-order-view','OutsideOrderController@getOrderUpdateView');
    Route::post('/update-order-status','OutsideOrderController@updateOrderStatus');
    Route::get('/outside-orders/{transaction_id}/print', 'OutsideOrderController@printInvoice')->name('outsideorder.printInvoice');
    //end
    ...
    Route::get('/sells/pos/get-recent-transactions', 'SellPosController@getRecentTransactions');
	    Route::get('/sells/pos/get-draft-transactions', 'SellPosController@getDraftTransactions');
	...
	Route::get('/sells/postab/get-product-suggestion', 'SellPosTabController@getProductSuggestion');
    Route::resource('pos', 'SellPosController');
    Route::resource('postab', 'SellPosTabController');
    Route::post('/pos/deleteSell/{id}','SellPosController@deleteSell');
	Route::post('/pos/checkmanagerpermission','SellPosController@checkStoreManagerPermission');
	...
	Route::get('/reports/profit-loss-payments', 'ReportController@getProfitLossPyamentMethods');
	...
	Route::get('/reports/product-stock-report', 'ReportController@getProductStockReport');
    ...
    Route::get('/reports/expense-report', 'ReportController@getExpenseReportV2');
    ...
    Route::get('/reports/today/profits', 'ReportController@getTodayProfits');
    ...
    Route::post('stock-transfers/updateStatus', 'StockTransferController@changeStatus');
    ...
    Route::get('/subscriptions/edit/{id}', 'SubscriptionController@edit');
    Route::get('/subscriptions/view/{id}', 'SubscriptionController@view');
    
    Route::post('/subscriptions/insert', 'SubscriptionController@insert');
    Route::post('/subscriptions/update/{id}', 'SubscriptionController@update');
    Route::post('/subscriptions/delete/{id}', 'SubscriptionController@delete');

    Route::post('/subscriptions/suspend/{id}', 'SubscriptionController@suspendSubscription');
    Route::post('/subscriptions/unsuspend/{id}', 'SubscriptionController@unsuspendSubscription');
    Route::post('/subscriptions/pause/{id}', 'SubscriptionController@pauseSubscription');
    Route::post('/subscriptions/resume/{id}', 'SubscriptionController@resumeSubscription');
    Route::post('/subscriptions/start/{id}', 'SubscriptionController@startSubscription');

    Route::get('/subscriptions/plans', 'SubscriptionController@plansIndex');
    Route::get('/subscriptions/plans/create', 'SubscriptionController@plansCreate');
    Route::get('/subscriptions/plans/edit/{id}', 'SubscriptionController@plansEdit');
    Route::get('/subscriptions/plans/view/{id}', 'SubscriptionController@plansView');

    Route::post('/subscriptions/plans/insert', 'SubscriptionController@plansInsert');
    ...
    Route::group(['prefix' => 'modules'], function () {
		...
		Route::get('/kitchen/mark-as-cooked-item', 'Restaurant\KitchenController@markAsCookedItem');
